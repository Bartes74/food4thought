              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  <div className={`${isDarkMode ? 'bg-dark-surface' : 'bg-white'} rounded-lg p-6 shadow-lg`}>
                    ...
                    <h3 className="text-lg font-semibold mb-1">Wszyscy użytkownicy</h3>
                    <p className="text-2xl font-bold text-primary">{adminStats.users?.total || 0}</p>
                  </div>
                  
                  <div className={`${isDarkMode ? 'bg-dark-surface' : 'bg-white'} rounded-lg p-6 shadow-lg`}>
                    <div className="text-4xl mb-2">🟢</div>
                    <h3 className="text-lg font-semibold mb-1">Aktywni użytkownicy</h3>
                    <p className="text-2xl font-bold text-green-500">{adminStats.users?.active || 0}</p>
                    <p className="text-sm text-gray-500">{timeRange === 'today' ? 'dzisiaj' : `w ${timeRange === 'week' ? 'tygodniu' : 'miesiącu'}`}</p>
                  </div>
                  
                  <div className={`${isDarkMode ? 'bg-dark-surface' : 'bg-white'} rounded-lg p-6 shadow-lg`}>
                    <div className="text-4xl mb-2">📈</div>
                    <h3 className="text-lg font-semibold mb-1">Nowi użytkownicy</h3>
                  ...
                  <div className={`${isDarkMode ? 'bg-dark-surface' : 'bg-white'} rounded-lg p-6 shadow-lg`}>
                    <div className="text-4xl mb-2">🔄</div>
                    <h3 className="text-lg font-semibold mb-1">Retencja</h3>
                    <p className="text-2xl font-bold text-purple-500">{adminStats.users?.retention || 0}%</p>
                    <p className="text-sm text-gray-500">7-dniowa</p>
                  </div>
                </div>

                {/* Najbardziej aktywni użytkownicy */}
                <div className={`${isDarkMode ? 'bg-dark-surface' : 'bg-white'} rounded-lg p-6 shadow-lg`}>
                  <h3 className="text-xl font-semibold mb-4">Najbardziej aktywni użytkownicy</h3>
                      ...
                      <div key={user.id} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-500">{user.completedCount} ukończonych odcinków</p>
                          </div>
                        </div>
                        <div className="text-right">
                          <p className="font-bold">{formatTime(user.totalListeningTime)}</p>
                          <p className="text-sm text-gray-500">czas słuchania</p>
                        </div>
                      </div>
            ...
            {activeTab === 'episodes' && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  <div className={`${isDarkMode ? 'bg-dark-surface' : 'bg-white'} rounded-lg p-6 shadow-lg`}>
                    <div className="text-4xl mb-2">🎧</div>
                    <h3 className="text-lg font-semibold mb-1">Wszystkie odcinki</h3>
                    <p className="text-2xl font-bold text-primary">{adminStats.episodes?.total || 0}</p>
                  </div>
                  
                  <div className={`${isDarkMode ? 'bg-dark-surface' : 'bg-white'} rounded-lg p-6 shadow-lg`}>
                    <div className="text-4xl mb-2">⭐</div>
                    <h3 className="text-lg font-semibold mb-1">Średnia ocena</h3>
                  ...
                  <div className={`${isDarkMode ? 'bg-dark-surface' : 'bg-white'} rounded-lg p-6 shadow-lg`}>
                    <div className="text-4xl mb-2">✅</div>
                    <h3 className="text-lg font-semibold mb-1">Współczynnik ukończenia</h3>
                    <p className="text-2xl font-bold text-green-500">{adminStats.episodes?.completionRate || 0}%</p>
                  </div>
                  
                  <div className={`${isDarkMode ? 'bg-dark-surface' : 'bg-white'} rounded-lg p-6 shadow-lg`}>
                    <div className="text-4xl mb-2">🕒</div>
                    <h3 className="text-lg font-semibold mb-1">Średni czas ukończenia</h3>
                ...
                <div className={`${isDarkMode ? 'bg-dark-surface' : 'bg-white'} rounded-lg p-6 shadow-lg`}>
                  <h3 className="text-xl font-semibold mb-4">Najpopularniejsze odcinki</h3>
                  <div className="space-y-3">
                    {adminStats.episodes?.topPopular?.map((episode, index) => (
                      <div key={episode.id} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                        ...
                        <div className="text-right">
                          <p className="font-bold">{episode.listensCount} odsłuchań</p>
                          <p className="text-sm text-gray-500">
                            {episode.averageRating ? `${episode.averageRating.toFixed(1)}/5 ⭐` : 'Brak ocen'}
                          </p>
                        </div>
                      </div>
                    )) || <p className="text-gray-500">Brak danych</p>}
                ...
                <div className={`${isDarkMode ? 'bg-dark-surface' : 'bg-white'} rounded-lg p-6 shadow-lg`}>
                  <h3 className="text-xl font-semibold mb-4">Najczęściej przerywane odcinki</h3>
                  <div className="space-y-3">
                    {adminStats.episodes?.mostAbandoned?.map((episode, index) => (
                      <div key={episode.id} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                        ...
                        <div className="text-right">
                          ...
                          <p className="text-sm text-gray-500">porzuceń</p>
                        </div>
                      </div>
                    )) || <p className="text-gray-500">Brak danych</p>}
                  </div>
            ...
            {activeTab === 'series' && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  <div className={`${isDarkMode ? 'bg-dark-surface' : 'bg-white'} rounded-lg p-6 shadow-lg`}>
                    <div className="text-4xl mb-2">📚</div>
                    <h3 className="text-lg font-semibold mb-1">Wszystkie serie</h3>
                    <p className="text-2xl font-bold text-primary">{adminStats.series?.total || 0}</p>
                  </div>
                  
                  <div className={`${isDarkMode ? 'bg-dark-surface' : 'bg-white'} rounded-lg p-6 shadow-lg`}>
                    <div className="text-4xl mb-2">🟢</div>
                    <h3 className="text-lg font-semibold mb-1">Aktywne serie</h3>
                    <p className="text-2xl font-bold text-green-500">{adminStats.series?.active || 0}</p>
                  </div>
                  
                  <div className={`${isDarkMode ? 'bg-dark-surface' : 'bg-white'} rounded-lg p-6 shadow-lg`}>
                    <div className="text-4xl mb-2">🏆</div>
                    <h3 className="text-lg font-semibold mb-1">Najlepsza seria</h3>
                  ...
                  <div className={`${isDarkMode ? 'bg-dark-surface' : 'bg-white'} rounded-lg p-6 shadow-lg`}>
                    <div className="text-4xl mb-2">📈</div>
                    <h3 className="text-lg font-semibold mb-1">Średnie ukończenie</h3>
                ...
                <div className={`${isDarkMode ? 'bg-dark-surface' : 'bg-white'} rounded-lg p-6 shadow-lg`}>
                  <h3 className="text-xl font-semibold mb-4">Statystyki według serii</h3>
                      ...
                      <div key={series.id} className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                        <div className="flex items-center justify-between mb-3">
                          ...
                          <div className="flex items-center gap-4 text-sm text-gray-500">
                            <span>{series.episodeCount} odcinków</span>
                            <span>{series.activeUsers} aktywnych użytkowników</span>
                          </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-3">
                          ...
                          <div>
                            <p className="text-sm text-gray-500">Współczynnik ukończenia</p>
            ...
            {activeTab === 'technical' && (
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {/* Języki interfejsu */}
                  <div className={`${isDarkMode ? 'bg-dark-surface' : 'bg-white'} rounded-lg p-6 shadow-lg`}>
                    <h3 className="text-xl font-semibold mb-4">Języki interfejsu</h3>
                    <div className="space-y-3">
                  ...
                  <div className={`${isDarkMode ? 'bg-dark-surface' : 'bg-white'} rounded-lg p-6 shadow-lg`}>
                    <h3 className="text-xl font-semibold mb-4">Prędkości odtwarzania</h3>
                    <div className="space-y-3">
                ...
                {/* Aktywność w czasie */}
                <div className={`${isDarkMode ? 'bg-dark-surface' : 'bg-white'} rounded-lg p-6 shadow-lg`}>
                  <h3 className="text-xl font-semibold mb-4">Aktywność według godzin</h3>
